...
class functions():
    ...
    def analysisAndQuantisation(self, sampleFrequency, ys, AnalysisFilterResult, DFTResolution, barkResolution,
        ...
        spreading_matrix = signal.spreadingfunctionmat(spreading_vector_db, tonalityidx)
