...
for alpha in alpha_list:
    yq, mTbarkquant = f.analysisAndQuantisation(sampleFrequency, ys,AnalysisFilterResult, DFTResolution, alpha = alpha)
    ...
    gain[alpha] = {'size' : os.stat("encoded.bin").st_size, 'SNR': SNR}
