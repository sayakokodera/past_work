...
tonalityidx = None # Varies the distance to masking threshold
...
yq, mTbarkquant = f.analysisAndQuantisation(sampleFrequency, ys,AnalysisFilterResult, DFTResolution, barkResolution,
                                            sRate/2, tonalityidx)
