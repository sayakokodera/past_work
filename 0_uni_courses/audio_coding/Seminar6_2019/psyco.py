...
class signals():
    ...
    def __init__(self, dft_resolution):

        self.alpha = 0.8
        self.sampling_freq = 44100
        self.duration = 3 * 60
        self.dft_resolution = int(dft_resolution)
    ...
    def spreadingfunctionmat(self,spreading_vector, tonalityidx = None):

        return ps.spreadingfunctionmat(spreading_vector, self.alpha,self.bark_resolution, tonalityidx)
    ...
    def maskingThresholdBark(self, mXbark,spreadingfuncmatrix, alpha):
        """ 
        Retrun
        ------
