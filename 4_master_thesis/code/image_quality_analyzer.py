...
class ImageQualityAnalyzerGCNR():
    ...
    Example usage:
        ...
        iqaGCNR.set_target_area(R_true, thresholdGCNR)
        results = iqaGCNR.get_gcnr(Reco)  

    """
    # constructor
    def __init__(self, N_hist = 10, target_area = None, using_envelope = False):
        """ Constructor        
        Parameters
        ----------
