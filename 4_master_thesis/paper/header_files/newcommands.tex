...
% Font setting for headings
\addtokomafont{part}{\bfseries \rmfamily}
\addtokomafont{partnumber}{\bfseries \rmfamily} % Numbering only necessary for part!
\addtokomafont{partentry}{\bfseries \rmfamily}
\addtokomafont{chapter}{\bfseries \rmfamily}
\addtokomafont{chapterentry}{\bfseries \rmfamily}
...
%%% For illustration of transducer & cameras %%%
\newcommand{\Nx}{3}
\newcommand{\Ny}{2}
\newcommand{\ddx}{1.5cm}
\newcommand{\ddy}{\ddx}
	...
	\scalebox{#1}{
		\begin{tikzpicture}
			\begin{axis}[
				...
				\input{figures/coords_1D/batch_itp/p_pred.tex} % addplot coordinates: p_pred
			\end{axis}
		\end{tikzpicture}
	}
}
