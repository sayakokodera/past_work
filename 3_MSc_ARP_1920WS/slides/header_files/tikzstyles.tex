...
\tikzstyle{largebox} = [rectangle, draw, tui_orange, very thick,
    text width=7cm, text centered, minimum height=3cm]
\tikzstyle{block4} = [rectangle, draw, 
    text width=2.2cm, text centered, minimum height=2cm]
